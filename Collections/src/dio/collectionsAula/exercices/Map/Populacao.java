...
public class Populacao {
    public static void main(String[] args) {
        ...
        System.out.println(populaçãoEstadosNE.get("PE"));
        System.out.println();
        ...
        System.out.printf("Maior população (%s) - (%d)\n",
        ...
        System.out.println("Média das populações: " + (soma / populaçãoEstadosNE.size()));
        System.out.println();
        ...
        System.out.println("Lista vazia: " + populaçãoEstadosNE.isEmpty());
        System.out.println();
